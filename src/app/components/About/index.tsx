...
export default function About() {
	return (
		<div className="bg-slate-50 w-full grid gap-10">
			...
			<div className="grid justify-center items-center mx-auto max-w-5xl gap-10 lg:grid-cols-2 lg:gap-0">
				...
				<p className="px-20 text-center lg:px-0 lg:text-left">
					...
					programming since I was at class 8 Junior High School. First
					...
					learning JavaScript, I was also learning HTML and CSS because HTML and
					CSS are the basic of web development.
					...
					JavaScript framework that is React.js, I really like React.js because
					I could create fast user interfaces easily. After learning React, I
					jumped to learn Next.js, I think this JavaScript framework is quite
					complicated due to there is a bunch of data fetching methods in
					Next.js, but I will keep learning even though it&apos;s difficult to
					understand.
				</p>
			</div>
		</div>
